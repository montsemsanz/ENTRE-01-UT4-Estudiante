...
public class NotaEstudianteUnidad {
    ...
    public double calcularNotaUnidad() {
         double notaControlesFinal = notaControles * ((double)unidad.getPonderacion().getControles()/100);
         double notaActividadesFinal = notaActividades * ((double)unidad.getPonderacion().getActividades()/100);
         double notaProyectosFinal = notaProyectos * ((double)unidad.getPonderacion().getProyectos()/100);
         double notaFinal = (notaControlesFinal + notaActividadesFinal + notaProyectosFinal);
         return notaFinal;
    }
