...
public class TestEstudiante {
    ...
    public static void main(String[] args) {
       ...
       UnidadTrabajo unidadTrabajo = new UnidadTrabajo("Interacción de objetos. Estructura de control iterativa", 25, 11, 2022, 55, 60, 10, 30);
       ...
       UnidadTrabajo unidadTrabajo3 = new UnidadTrabajo("Definición de una clase. Estructura condicional", new Fecha(16,10,2022), 35, new PonderacionInstrumentos(65,10,25));
